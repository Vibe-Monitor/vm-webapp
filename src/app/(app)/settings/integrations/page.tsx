    ...
    },
    {
      ...
      integrations: [
        ...
        },
        {
          ...
          lockMessage: 'Grafana is available for team workspaces only',
        ...
        },
        {
          ...
          isLocked: isPersonalSpace,
          lockMessage: 'AWS CloudWatch is available for team workspaces only',
        ...
        },
        {
          ...
          isLocked: isPersonalSpace,
          lockMessage: 'Datadog is available for team workspaces only',
      ...
      integrations: [
        {
          ...
          isLocked: isPersonalSpace,
          lockMessage: 'Slack is available for team workspaces only',
