...
export default function PrivacyPolicy() {
  return (
    <div className="min-h-screen" style={{ background: '#0F1828' }}>
      <div className="max-w-4xl mx-auto px-6 py-16">
        {/* Back Button */}
        <Link href="/" className="inline-flex items-center gap-2 mb-8 text-[#98A3B1] hover:text-[#6266FA] transition-colors">
        ...
        >
          <h1 style={{ fontSize: '48px', fontWeight: 700, color: '#E5E7EB', marginBottom: '16px' }}>
            Privacy Policy
          </h1>
          <p style={{ fontSize: '16px', color: '#98A3B1', marginBottom: '48px' }}>
        ...
        >
          <div style={{ color: '#E5E7EB', lineHeight: '1.8' }}>
            ...
            <p style={{ fontSize: '15px', color: '#98A3B1', marginBottom: '16px' }}>
              <strong style={{ color: '#E5E7EB' }}>Personal Data</strong> means any information about an identified or identifiable individual.
            </p>
            <p style={{ fontSize: '15px', color: '#98A3B1', marginBottom: '16px' }}>
              <strong style={{ color: '#E5E7EB' }}>Usage Data</strong> means information collected automatically (such as logs, metrics, analytics) when you access or use the Service.
            </p>
            <p style={{ fontSize: '15px', color: '#98A3B1', marginBottom: '16px' }}>
              <strong style={{ color: '#E5E7EB' }}>Account</strong> means a unique account created for you to access our Service.
            </p>
            <p style={{ fontSize: '15px', color: '#98A3B1', marginBottom: '16px' }}>
              <strong style={{ color: '#E5E7EB' }}>Service</strong> means the Service offered by VibeMonitor.ai as described on the Site, including monitoring, alerting, root cause analysis.
            </p>
            <p style={{ fontSize: '15px', color: '#98A3B1', marginBottom: '16px' }}>
              <strong style={{ color: '#E5E7EB' }}>You/Your</strong> refers to you as a user of the Service, and if you are accessing on behalf of an organization, the organization.
            </p>
            ...
            <h3 style={{ fontSize: '20px', fontWeight: 600, color: '#E5E7EB', marginTop: '32px', marginBottom: '12px' }}>
              2.1. Information you provide us directly:
            </h3>
            <ul style={{ fontSize: '15px', color: '#98A3B1', paddingLeft: '24px', marginBottom: '16px' }}>
            ...
            <p style={{ fontSize: '15px', color: '#98A3B1', marginBottom: '16px' }}>
              To exercise your rights, please contact us at <a href="mailto:support@vibemonitor.ai" style={{ color: '#6266FA', textDecoration: 'none' }}>support@vibemonitor.ai</a>.
            </p>
            ...
            <div style={{
              ...
              borderRadius: '12px',
              marginTop: '24px',
              borderLeft: '4px solid #6266FA'
            }}>
              <p style={{ fontSize: '15px', color: '#E5E7EB', marginBottom: '8px', fontWeight: 600 }}>
                Greenfield Gate Ventures LLP
              </p>
              <p style={{ fontSize: '14px', color: '#98A3B1', marginBottom: '4px' }}>
                (Operating as VibeMonitor.ai)
              </p>
              <p style={{ fontSize: '14px', color: '#98A3B1', marginBottom: '4px' }}>
                LLP Identification Number: ACR-9694
              </p>
              <p style={{ fontSize: '14px', color: '#98A3B1', marginBottom: '16px' }}>
              ...
              <p style={{ fontSize: '14px', color: '#98A3B1' }}>
                Email: <a href="mailto:support@vibemonitor.ai" style={{ color: '#6266FA', textDecoration: 'none' }}>support@vibemonitor.ai</a>
              </p>
            </div>
          </div>
        </motion.div>
