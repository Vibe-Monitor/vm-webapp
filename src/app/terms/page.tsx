        ...
        >
          <div style={{ color: '#E5E7EB', lineHeight: '1.8' }}>
            ...
            <p style={{ fontSize: '15px', color: '#98A3B1', marginBottom: '16px' }}>
              <strong style={{ color: '#E5E7EB' }}>Service</strong> means the online monitoring, error-detection, alerting, analysis and debugging platform provided by the Company, including the website, APIs, integrations (Slack, GitHub, Grafana) and related documentation.
            </p>
            <p style={{ fontSize: '15px', color: '#98A3B1', marginBottom: '16px' }}>
              <strong style={{ color: '#E5E7EB' }}>User/You</strong> means you or the entity you represent that is using the Service.
            </p>
            <p style={{ fontSize: '15px', color: '#98A3B1', marginBottom: '16px' }}>
              <strong style={{ color: '#E5E7EB' }}>Account</strong> means a unique user account created for accessing the Service.
            </p>
            <p style={{ fontSize: '15px', color: '#98A3B1', marginBottom: '16px' }}>
              <strong style={{ color: '#E5E7EB' }}>Subscription Plan</strong> means a paid or free plan through which you access the Service under a subscription model.
            </p>
